      ...
      <div class="overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead class="bg-gray-50 dark:bg-gray-800">
            <tr>
              <th class="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Name</th>
              <th class="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Color</th>
              <th class="px-4 py-2 text-left text-xs font-semibold text-gray-500 dark:text-gray-400">Active</th>
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-900">
            ...
            <tr v-else v-for="cat in categories" :key="cat.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
              ...
              <td class="px-4 py-3">
                <input type="color" v-model="cat.color" @change="updateCategory(cat)" class="h-10 w-14 rounded-md border border-gray-200 dark:border-gray-700" />
              </td>
              <td class="px-4 py-3">

            ...
            <tr v-for="template in filteredTemplates" :key="template.id" :class="!template.status ? 'opacity-60' : ''">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button
                  ...
                  :class="template.status ? 'text-orange-600 hover:text-orange-900 dark:text-orange-400 dark:hover:text-orange-300' : 'text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300'"
                  class="mr-3"
                >
                  {{ template.status ? 'Deactivate' : 'Activate' }}
                </button>
                <router-link

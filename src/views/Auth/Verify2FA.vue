            ...
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Enter the 6-digit code from your authenticator app or sent to your email.
                </p>
              </div>
...
const userEmail = ref(localStorage.getItem('pending_2fa_email') || '')
...
const startTimer = () => {
  timer = setInterval(() => {
    if (timeRemaining.value > 0) {
      ...
      clearInterval(timer)
      toast.error('Verification code has expired. Please sign in again.')
      handleBack()
    }
  }, 1000)
}

                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <p v-if="validationErrors.password_confirmation" class="mt-1 text-xs text-red-600 dark:text-red-400">
                        {{ validationErrors.password_confirmation[0] }}
                      </p>
                      <p v-else-if="password && passwordConfirmation && password !== passwordConfirmation" class="mt-1 text-xs text-red-600 dark:text-red-400">
...
const otpCode = ref(route.query.otp as string || '')
const password = ref('')

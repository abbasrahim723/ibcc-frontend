                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      />
                      <p v-if="validationErrors.first_name" class="mt-1 text-xs text-red-600 dark:text-red-400">
                    ...
                    <div class="sm:col-span-1">
                      ...
                      />
                      <p v-if="validationErrors.last_name" class="mt-1 text-xs text-red-600 dark:text-red-400">

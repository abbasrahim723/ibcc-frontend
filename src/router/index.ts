...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: 'customer-edit',
      component: () => import('../views/Admin/CustomerFormView.vue'),
      meta: { requiresAuth: true, permission: 'customers.edit' }
    },
    {
      path: '/customers/:id',
      name: 'CustomerDetail',
    ...
    // Location Management
    {
      ...
      meta: { requiresAuth: true, title: 'Countries', permission: 'locations.view' }
    },
    {
      path: '/admin/locations/states',
      name: 'states',
      component: () => import('../views/Admin/Locations/StatesView.vue'),
      meta: { requiresAuth: true, title: 'States', permission: 'locations.view' }
    },
    {
      path: '/admin/locations/cities',
      name: 'cities',
      component: () => import('../views/Admin/Locations/CitiesView.vue'),
      meta: { requiresAuth: true, title: 'Cities', permission: 'locations.view' }
    },
    {
      path: '/admin/locations/towns',
      name: 'towns',
      component: () => import('../views/Admin/Locations/TownsView.vue'),
      meta: { requiresAuth: true, title: 'Towns', permission: 'locations.view' }
    },
    {
      path: '/form-elements',
      name: 'Form Elements',
...
router.beforeEach(async (to, from, next) => {
  document.title = `${to.meta.title || 'IBCC'} | IBCC`

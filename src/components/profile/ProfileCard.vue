      ...
      <div class="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          <div class="shrink-0">
            ...
            <div v-if="loading" class="h-24 w-24 animate-pulse rounded-full bg-gray-200 dark:bg-gray-700"></div>
            <ProfilePhotoManager v-else />
          </div>
          <div class="order-3 xl:order-2">
            <!-- Skeleton Name -->
            <div v-if="loading" class="mb-2 h-6 w-48 animate-pulse rounded bg-gray-200 dark:bg-gray-700"></div>
            <h4
              v-else
            ...
            >
              <!-- Skeleton Role and Location -->
              <div v-if="loading" class="flex flex-col gap-1 xl:flex-row xl:gap-3">
